...
local function loadSounds()
  dieSound = audio.loadSound( "Sounds/coronavaris.mp3" )
...
local function setupBird()
  ...
  local imageSheet = display.newImageRect( "Assets/corona.png", 60, 50 )
...
local function setupImages()
  local ground = display.newImageRect( "Assets/back.jpg", display.actualContentWidth, display.actualContentHeight )
...
local loadingText = display.newText( "Debug info", display.contentCenterX, display.contentCenterY*1.9, nil, 17)
